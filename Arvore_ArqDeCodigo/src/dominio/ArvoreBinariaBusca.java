...
public class ArvoreBinariaBusca {
	...
	public void insereAluno(String nome ,int cr,int matricula){
		NoArvore aluno = new NoArvore(nome,cr,matricula);
	...
	public boolean insereNo(NoArvore no) {
		// a árvore ainda está vazia?
		if (ptRaiz == null) {
			// vamos criar o primeiro nó e definí-lo como a raiz da árvore
			ptRaiz = new NoArvore(no); // cria um novo nó
		}
