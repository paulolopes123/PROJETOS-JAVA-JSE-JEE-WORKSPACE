...
public class ArvoreBinariaBusca {
	...
	public boolean inserir(int valor) {
		...
		if (raiz == null) {
			// vamos criar o primeiro nó e defini-lo como a raiz da árvore
	...
	// Método que permite disparar a travessia pre-ordem
	public void preOrdem() {

		preOrdem(raiz);

	}
	// sobrecarga do método preOrdem com um parâmetro (esta é a versão recursiva
	// do método)
	...
	// Método que permite disparar a travessia pos-ordem
	public void posOrdem() {

		posOrdem(raiz);

	}
	// sobrecarga do método posOrdem com um parâmetro (esta é a versão recursiva
	// do método)
