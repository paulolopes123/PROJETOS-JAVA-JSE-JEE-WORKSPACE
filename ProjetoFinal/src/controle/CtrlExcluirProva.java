...
public class CtrlExcluirProva {
	 ...
	 */
	private JanelaExcluirProva jExcluirProva;
	...
	public CtrlExcluirProva(CtrlPrograma p) throws ControleException, DadosException {
	...
	public void iniciar() throws ControleException, DadosException {
		// Crio e abro a janela de exclusão da prova
		this.jExcluirProva = new JanelaExcluirProva(this);
	...
	public void terminar() throws ControleException {
		...
		this.atual = null;
		// Fecho a janela
		this.jExcluirProva.setVisible(false);
