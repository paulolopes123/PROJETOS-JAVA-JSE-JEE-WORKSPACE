...
public class Professor extends Usuario implements IDados, ITabelavel, Comparable<Professor>, Serializable {
	...
	private enum Status {
		...
		public static void validarTransicaoStatus(Status anterior, Status novo) throws DadosException {
			if (anterior == null && novo == inaptoUsarSistema
				...
				return;
			throw new DadosException(new ErroDeDominio(1, "Um Professor n�o pode deixar de ser "
	...
	// metodo adiciona Prova do atributo de relacionamento n-�rio
	...
	// metodo remove Prova do atributo de relacionamento n-�rio
	...
	// metodo adiciona Questao do atributo de relacionamento n-�rio
	...
	// metodo remove Questao do atributo de relacionamento n-�rio
	...
	// metodo adiciona Comentario do atributo de relacionamento n-�rio
	...
	// metodo remove Comentario do atributo de relacionamento n-�rio
	...
	public void validarMatr(String m) throws DadosException {
		if (m == null || m.length() == 0)
			throw new DadosException(new ErroDeDominio(2, "A Matricula n�o pode ser nula"));
	}
	...
	/**
	 * M�todo utilizado para colocar os Professores em ordem
	 */
