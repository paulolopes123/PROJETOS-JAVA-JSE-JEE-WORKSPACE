...
/**
 * Implementa a classe Opção que tem o "implements Serializable" para realizar o
...
public class Opcao implements IDados, ITabelavel, Serializable {
	...
	public void validarEhCorreta(boolean e) throws DadosException {
		if (e != true || e != false)
			throw new DadosException(new ErroDeDominio(2, "Opção Inválida"));
	}

	@RegraDeDominio
	public void validarQuestao(Questao questao) throws DadosException {
		if (questao == null)
			throw new DadosException(new ErroDeDominio(3, "A Questão não pode ser nulo"));
	}
	...
	public void validarResponde(Responde responde) throws DadosException {
		if (responde == null)
			throw new DadosException(new ErroDeDominio(4, "A Resposta não pode ser nulo"));
	}
